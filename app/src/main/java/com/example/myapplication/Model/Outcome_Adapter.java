...
import com.example.myapplication.Activity.Mange_Outcome_Activity;
import com.example.myapplication.Activity.R;
import java.util.List;
import java.util.Map;

public class Outcome_Adapter extends SimpleAdapter {
    private Context context;
    List list;
    public static TextView e_id,e_money,e_positon,e_comment,e_kind,e_date;

    public Outcome_Adapter(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent13.setClass(context,Mange_Outcome_Activity.class);
